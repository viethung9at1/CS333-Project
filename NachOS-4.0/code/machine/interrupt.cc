...
// t hiểu thế này, cái interrupt này nó gọi kernel của main đúng ko, nhưng gọi
// qua mấy thằng pcb, ptable, synch, mà path đến mấy file này nằm chung với
// thằng main.h, nên mấy thằng đó tìm được cái kernel, còn thằng này phải
// include cái main.h theo cái path của thằng interrupt, nghĩa là tuywf
// interrupt lùi 1 cái, ra folder ngoài, rồi vô main.h, đại loại thế, nó mới tìm
// được kernel. hiểu ko
